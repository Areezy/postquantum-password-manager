...
export default function ViewEntry() {
  ...
  const { activePassword } = useContext(AppContext);
  ...
  return (
    <div className="grid grid-cols-4">
      ...
      <div className="col-start-2 col-end-5 bg-gray-50">
        ...
        >
          <h1 className="text-lg font-bold mt-3">{`View Entry For ${activePassword.name} `}</h1>
